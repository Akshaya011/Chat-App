        ...
        {messages &&
          messages.map((message) => (
            ...
            >
              ...
              <div className={`chat-bubble ${message.senderId == authUser._id?"bg-primary text-base-content":""} ${selectedMessages.includes(message._id)?"bg-green-300":""}`} onDoubleClick={()=>handleDoubleClickMsg(message._id)}>
                {message.image && (
                  <img
                    src={message.image}
                    alt="Attachment"
